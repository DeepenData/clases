...
- Se ve más ordenado-
- más fácil cambiar inputs solo modificando la linea 1-->
...
Existen varios funciones para el análisis de la estructura de datos. 
...
mi.set %>% glimpse()    # Muy útil para explorar, muestra las columnas con algunos datos de ejemplo, señalando que tipo de datos son. (Podemos ver el error en "motivation" en que datos tipo "1, 3, 2, ..." son caracteres en lugar de integros) 
```

### Pipelines para limpieza de datos

Es posible construir análisis más complejos usando el operador _pipe_.
...
A menudo los datos vienen en un formato que no es conveniente para lo que queremos, ya sea porque los nombres son crípticos, o no coinciden con identificadores estándar que estamos usando. 
...
nombres.columnas  %>%  # Cambiamos el nombre de las columnas a español
